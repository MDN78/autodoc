# Проект по тестированию сервиса поиска и подбора автозапчастей, интернет магазин "Автодок"
...
- [x] Добавление продукта авторизованным пользователем в корзину по наименованию и номеру детали
